...
nextQuestion.addEventListener("click", () => {
    ...
    .then((e) => {
        ...
        if (cont < 11) {
            ...
            cabecera.innerHTML ='<div><div class = "cabecera"><img src="/assets/pngwing.com.png" alt="" srcset="" width="30px" height="30px"><p>The Question Machine</p></div></div>'
        ...
        checkAnswer.addEventListener("click", () => {
            ...
            if (inputChecked === 'correct') {
                puntaje++
                inputs.forEach((input) => {
                    input.nextElementSibling.style = "background-color: red"
                    if (input.value=== 'correct') {
                        input.nextElementSibling.style = "background-color: green"
                    }
                })
